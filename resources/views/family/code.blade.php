        ...
        <div class="w-full max-w-2xl relative">
            ...
            <div class="w-full bg-white rounded-3xl shadow-2xl p-6 sm:p-8">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">{{ $family->name }}</h1>
                    <p class="text-gray-600 text-sm">Family Code</p>
                </div>
                @if (session('status'))
                ...
                <div class="mb-8">
                    <div class="bg-gray-100 rounded-lg p-4">
                        <label for="code" class="block text-sm font-medium text-gray-700 mb-2">Family Code</label>
                        <div class="flex items-center space-x-3">
                            ...
                            <button
                                ...
                                class="px-4 py-3 bg-gradient-to-r from-yellow-500 to-lime-500 text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-500/50"
                            >
                                Copy
                            </button>
                        </div>
                        <p class="mt-2 text-sm text-gray-600">Share this code with family members to let them join</p>
                    </div>
                </div>
            </div>
        </div>
